...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        System.out.println("Método de Cuadratura Gaussiana - Ejercicio 2");
        Function<Double, Double> f = x -> Math.exp(-x*x); // e^(-x^2)
        double a = -1;
        double b = 1;
        double resultado = cuadraturaGaussiana(f, a, b);
        System.out.println("Integral de e^(-x²) entre -1 y 1: " + resultado);
    }
}
