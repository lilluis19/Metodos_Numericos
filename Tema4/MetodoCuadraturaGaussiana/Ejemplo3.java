...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        System.out.println("Método de Cuadratura Gaussiana - Ejercicio 3");
        Function<Double, Double> f = x -> Math.log(x + 2); // ln(x+2)
        double a = 0;
        double b = 3;
        double resultado = cuadraturaGaussiana(f, a, b);
        System.out.println("Integral de ln(x+2) entre 0 y 3: " + resultado);
    }
}
